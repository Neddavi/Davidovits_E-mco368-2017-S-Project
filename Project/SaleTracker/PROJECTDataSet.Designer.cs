...
namespace SaleTracker {
    ...
    public partial class PROJECTDataSet : global::System.Data.DataSet {
        ...
        public partial class ITEMDataTable : global::System.Data.TypedTableBase<ITEMRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ITEMRow AddITEMRow(string Item_ID, string Description, string Category, decimal Price) {
            ...
            private void InitClass() {
                ...
                this.columnItem_ID.MaxLength = 4;
...
namespace SaleTracker.PROJECTDataSetTableAdapters {
    ...
    public partial class ITEMTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ITEM] WHERE (([Item_ID] = @Original_Item_ID) AND ([Description" +
                "] = @Original_Description) AND ([Category] = @Original_Category) AND ([Price] = " +
                "@Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ITEM] ([Item_ID], [Description], [Category], [Price]) VALUES (" +
                "@Item_ID, @Description, @Category, @Price);\r\nSELECT Item_ID, Description, Catego" +
                "ry, Price FROM ITEM WHERE (Item_ID = @Item_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ITEM] SET [Item_ID] = @Item_ID, [Description] = @Description, [Category] = @Category, [Price] = @Price WHERE (([Item_ID] = @Original_Item_ID) AND ([Description] = @Original_Description) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price));
SELECT Item_ID, Description, Category, Price FROM ITEM WHERE (Item_ID = @Item_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SaleTracker.Properties.Settings.Default.PROJECTConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Item_ID, Description, Category, Price FROM dbo.ITEM";
        ...
        public virtual int Fill(PROJECTDataSet.ITEMDataTable dataTable) {
        ...
        public virtual PROJECTDataSet.ITEMDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PROJECTDataSet.ITEMDataTable dataTable = new PROJECTDataSet.ITEMDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PROJECTDataSet.ITEMDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Item_ID, string Original_Description, string Original_Category, decimal Original_Price) {
        ...
        public virtual int Insert(string Item_ID, string Description, string Category, decimal Price) {
            if ((Item_ID == null)) {
        ...
        public virtual int Update(string Item_ID, string Description, string Category, decimal Price, string Original_Item_ID, string Original_Description, string Original_Category, decimal Original_Price) {
            if ((Item_ID == null)) {
                throw new global::System.ArgumentNullException("Item_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, string Category, decimal Price, string Original_Item_ID, string Original_Description, string Original_Category, decimal Original_Price) {
            return this.Update(Original_Item_ID, Description, Category, Price, Original_Item_ID, Original_Description, Original_Category, Original_Price);
        }
    }
